...
the code here do a **guess** for each input point **where they belong, if it's zone A or zone B** and then if the prediction is rigth then the point gets colerd green 🟢<p style="font-family: times, serif; font-size:11pt; font-style:italic"> This is my text number1</p> if not the point  gets colored red 🔴.
